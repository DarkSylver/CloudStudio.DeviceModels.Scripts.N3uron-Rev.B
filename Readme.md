...
# Parsing Script – N3uron - Rev. B

This **Parsing** script is designed for the **N3uron** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – N3uron Rev. B

Este script de **Parsing** está diseñado para el modelo **N3uron** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
